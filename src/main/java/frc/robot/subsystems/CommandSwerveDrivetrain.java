...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
  ...
  public CommandSwerveDrivetrain(
    ...
    new Trigger(RobotState::isEnabled).onTrue(Commands.runOnce(() -> configNeutralMode(NeutralModeValue.Brake)))
        .onFalse(Commands.runOnce(() -> configNeutralMode(NeutralModeValue.Coast)).ignoringDisable(true));
  }
