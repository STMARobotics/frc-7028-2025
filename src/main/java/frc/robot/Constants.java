...
public class Constants {
  ...
  public static class GamePieceManipulatorConstants {
    public static final AngularVelocity INTAKE_SPEED = RadiansPerSecond.of(50);

    public static final AngularVelocity OUTTAKE_SPEED = RadiansPerSecond.of(-50);

    public static final AngularVelocity SCORE_SPEED = RadiansPerSecond.of(-50);
