...
public class Constants {
  ...
  public static class ClimbConstants {
    public static final int DEVICE_ID_CLIMB_MOTOR_1 = 0;
    public static final int DEVICE_ID_CLIMB_MOTOR_2 = 0;
    ...
    public static final double CLIMB_ROTOR_TO_SENSOR_RATIO = (25 / 1); // 25 rotor turns = 1 shaft turn
    public static final SlotConfigs CLIMB_SLOT_CONFIGS = new SlotConfigs().withKP(140)
        .withKI(0.0)
        .withKD(0.0)
        .withKS(0.59)
        .withKV(0.5)
    ...
    public static Angle CLIMB_MAGNETIC_OFFSET = Radians.of(-0.35505078125);
